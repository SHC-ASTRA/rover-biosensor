...
class SerialRelay(Node):
    def __init__(self):
        ...
        super().__init__("citadel_serial_publisher")#previously 'serial_publisher'

        # Create a publisher to publish any output the MCU sends
        self.publisher = self.create_publisher(String, '/astra/bio/feedback', 10) 

        # Create a subscriber to listen to any commands sent for the MCU
        self.subscriber = self.create_subscription(String, '/astra/bio/control', self.send, 10)
